...
{
	const char *paths[] = { "/run/connman-vpn/test/",
				"/run/connman-vpn/test/file",
				"/run/connman-vpn/test/dir/file",
				"/run/user/1000/",
				"/run/user/1000/file",
				"/run/user/1000/test/file",
				"/run/user/1000/test/dir/file",
				"/tmp/test/",
				"/tmp/test/file",
				"/tmp/test/dir/file"};
	char *test_path;
...
{
	const char *paths[] = { "/run/connman-vpn",
				"/run/connman-vpn/",
				"/run/connman-vpn//",
				"/run/connman-vpn/./",
				"/run/connman-vpn/test",
				"/run/user",
				"/run/user/",
				"/run/user/1000",
				"/tmp/dir",
				"/run/connman-vpn/test/../../../",
				"/run/connman-vpn/test/../../../lib"};
	char *test_path;
	int i;
